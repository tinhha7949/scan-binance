...
async function ultimateFutureScanner() {
  ...
  for (let symbol of coins) {
    ...
    let volAvg = volumes.slice(-50).reduce((a, b) => a + b, 0) / 50;
...
// chạy liên tục
ultimateFutureScanner();
setInterval(ultimateFutureScanner, 5 * 60 * 1000);
